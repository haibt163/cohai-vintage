    ...
    <div className="page-shell">
      <section className="page-hero editorial-hero">
        ...
        <p className="page-dek">
          {locale === "vi"
            ? "Một kho lưu trữ về đồ đẹp, văn hoá vintage và những ý tưởng giúp phong cách có chiều sâu hơn."
            : "An archive of beautiful objects, vintage culture and ideas that give personal style more depth."}
        </p>
      </section>
