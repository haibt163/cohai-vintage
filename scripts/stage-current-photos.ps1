...
$groups = @{
  ...
  shop = @('LV-vintage-Concorde.webp','lv-concorde-1.jpg','LV-CONCORDE-2.webp','LV-NEVERFUL-MONO-MM.jpg','LV-neverfull-MM.jpg','lv-mono-neverfull-MM-3.jpg','LV-KELLY-MONO.jpg','LV-KELLY-LOCK.jpg')
}
